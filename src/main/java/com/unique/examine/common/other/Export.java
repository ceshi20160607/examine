...
//        char  aa = (char)(9+'0');
    ...
    public static void Cascade() {
        ...
        CellRangeAddressList provRangeAddressList = new CellRangeAddressList(1, 20, 11, 11);
        ...
        //对前20行设置有效性
        for(int i = 2;i < 20;i++){
            setDataValidation("L" ,sheetPro,i,12);
//            setDataValidation("B" ,sheetPro,i,3);
    ...
    private static  DataValidation getDataValidationByFormula(
        ...
        // 数据有效性对象
        // 绑定
        DataValidation data_validation_list = (DataValidation) dvHelper.createValidation(dvConstraint, regions);
