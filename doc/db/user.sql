...
`data_type` int(11) NOT NULL DEFAULT '0' COMMENT '数据权限 0默认全部 1本人，2本人及下属 3本部门 4本部门及下属部门 ',
`hidden` int(11) NOT NULL DEFAULT '0' COMMENT '0 隐藏 1 不隐藏',
`module_type` int(11) NOT NULL DEFAULT '0' COMMENT '0默认系统级别  1 审批级别',
`create_time` datetime DEFAULT NULL COMMENT '创建时间',
`create_user_id` bigint(20) NOT NULL COMMENT '创建人ID',
`update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
`update_user_id` bigint(20) DEFAULT NULL COMMENT '修改人ID',
...
`module_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属模块',
