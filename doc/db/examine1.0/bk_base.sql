/*
 ...
 Source Schema         : unexamine

 Target Server Type    : MySQL
 Target Server Version : 80012 (8.0.12)
 File Encoding         : 65001

 Date: 14/03/2023 14:27:12
*/
...
-- ----------------------------
-- Table structure for un_examine_condition
-- ----------------------------
DROP TABLE IF EXISTS `un_examine_condition`;
CREATE TABLE `un_examine_condition`  (
                                         `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                         `task_id` bigint(20) NOT NULL COMMENT '关联taskid',
                                         `parent_id` bigint(20) NULL DEFAULT 0 COMMENT '条件父关联 默认0',
                                         `deep_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '条件内关联的深度 有序',
                                         ...
                                         `module_field_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段名称',
                                         `module_field_search` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '比较条件符号',
                                         `module_field_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段值',
                                         `examine_task_id` bigint(20) NULL DEFAULT NULL COMMENT '条件内 关联的审批',
                                         `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
                                         `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                         `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
                                         `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
                                         ...
                                         `company_id` bigint(20) NULL DEFAULT NULL COMMENT '企业id',
                                         PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审批条件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of un_examine_condition
-- ----------------------------
...
-- ----------------------------
-- Table structure for un_examine_record_condition
-- ----------------------------
DROP TABLE IF EXISTS `un_examine_record_condition`;
...
-- ----------------------------
-- Records of un_examine_record_condition
-- ----------------------------
...
-- ----------------------------
-- Table structure for un_examine_record_task
-- ----------------------------
DROP TABLE IF EXISTS `un_examine_record_task`;
CREATE TABLE `un_examine_record_task`  (
                                           ...
                                           `end_user_id` bigint(20) NULL DEFAULT NULL COMMENT '上级审批截至人员 配置这个如果没有上级转该人审批 有上级这个配置失效',
                                           `transfer_flag` int(1) NULL DEFAULT 0 COMMENT '转他人处理flag 默认0 1表示这个是转他人的审批场景 2抄送的邮箱',
                                           `transfer_task_id` bigint(20) NULL DEFAULT NULL COMMENT '类型是转他人对应的主键',
                                           `copy_emails` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '抄送的 email',
                                           `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
                                           `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                           `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
...
-- ----------------------------
-- Records of un_examine_record_task
-- ----------------------------
...
-- ----------------------------
-- Table structure for un_examine_task
-- ----------------------------
DROP TABLE IF EXISTS `un_examine_task`;
